...
public class GUI_ParkirMobil extends javax.swing.JFrame {
 ...
 try {
        ...
        if (cmbPilihKendaraan.getSelectedIndex() == 0) {
            ...
            // DOWNCASTING
            if (k instanceof ParkirMobil) {
                ParkirMobil pm = (ParkirMobil) k;
                keteranganCasting = pm.infoKendaraanStandar();
            }

            JOptionPane.showMessageDialog(this,
                    "PERINGATAN: Kendaraan standar terkena denda karena parkir di zona khusus mobil listrik!",
                    "Pelanggaran Zona",
            ...
            if (k instanceof MobilElektrik) {
                MobilElektrik me = (MobilElektrik) k;
                keteranganCasting = me.infoMobilElektrik();
            }
        }
